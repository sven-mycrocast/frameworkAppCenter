...
/**
 Internal EventBus like structure, just an replacement for the NSNotificationCenter
 */
public class Broadcaster {

    fileprivate static var observersDic = [String: Any]()

    fileprivate static let notificationQueue = DispatchQueue(label: "sdk.test.event.center.dispatch.queue", attributes: .concurrent)
